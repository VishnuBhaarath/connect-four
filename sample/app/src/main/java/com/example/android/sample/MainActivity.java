...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawable drawable1 = getDrawable(R.drawable.background);
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gnheight = height.getText().toString();
                gnwidth = width.getText().toString();
                if((gnheight.length()==0)||( gnwidth.length()==0)){
               }
               else {
                   int h=Integer.parseInt(gnheight);
                   int w=Integer.parseInt(gnwidth);
                    if((h>80)&&(w>80)){
                    cellHeight = Integer.parseInt(gnheight);
                    cellWidth = Integer.parseInt(gnwidth);}
                    else{
                        Toast.makeText(MainActivity.this,"Dimensions are too small",Toast.LENGTH_SHORT).show();
                    }
                }}
